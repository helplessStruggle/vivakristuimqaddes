...
//user jitfa (ij,xy)
bool Board::isValid(int i, int j, bool Color, int dest_x, int dest_y, bool flag) {
...
bool Board::checkCanEat(int cX, int cY, bool color) {
	if (color) { //regarding white piece
		if (Board::isCoordValid(cX - 1, cY + 1)) {
			if (Board::board[cY + 1][cX - 1]->getColor() == false) {  //there's a piece bottom left you can potentially eat
				return true;
			}
		}
		if (Board::isCoordValid(cX + 1, cY - 1)) {
			if (Board::board[cY + 1][cX + 1]->getColor() == false) { //there's a piece bottom right you can potentially eat
				return true;
			}
		}
		if (board[cY][cX]->isKing()) {
			if (Board::isCoordValid(cX + 1, cY - 1)) {
				if (Board::board[cY - 1][cX - 1]->getColor() == false) { //there's a piece top left you can potentially eat
					return true;
				}
			}
			if (Board::isCoordValid(cX + 1, cY + 1)) {
				if (Board::board[cY - 1][cX + 1]->getColor() == false) { //there's a piece top right you can potentially eat
					return true;
				}
			}
		}
	}
	else { //regarding red piece
		if (Board::isCoordValid(cX - 1, cY - 1)) {
			if (Board::board[cY + 1][cX - 1]->getColor() == true) {  //there's a piece top left you can eat
				return true;
			}
		}
		if (Board::isCoordValid(cX + 1, cY - 1)) {
			if (Board::board[cY + 1][cX + 1]->getColor() == true) { //there's a piece top right you can eat
				return true;
			}
		}
		if (board[cY][cX]->isKing()) {
			if (Board::isCoordValid(cX - 1, cY + 1)) {
				if (Board::board[cY + 1][cX - 1]->getColor() == false) { //there's a piece bottom left you can eat
					return true;
				}
			}
			if (Board::isCoordValid(cX + 1, cY + 1)) {
				if (Board::board[cY + 1][cX + 1]->getColor() == false) { //there's a piece bottom right you can eat
					return true;
				}
			}
		}
...
bool checkBlankBox(int cX, int cY, bool color) {
